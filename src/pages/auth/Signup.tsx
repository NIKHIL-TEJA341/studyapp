...
import { Lock, Mail, Eye, EyeOff, Folder, User } from 'lucide-react';
...
const Signup = () => {
    ...
    return (
        <div className="min-h-screen bg-background flex flex-col md:flex-row text-text-primary overflow-hidden">
            {/* Left Side - Brand/Greeting (Desktop only) - Same as Login for consistency */}
            <div className="hidden md:flex w-1/2 bg-surface/30 relative items-center justify-center p-12">
                ...
                <div className="relative z-10 max-w-md">
                    ...
                    >
                        Join the <span className="text-primary">Study Revolution</span>.
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                    ...
                    >
                        Create your account to start organizing your learning journey today.
                    </motion.p>
                </div>
            </div>
                ...
                >
                    <div className="text-center md:text-left">
                        ...
                        <p className="mt-2 text-text-secondary">
                            ...
                            <Link to="/auth/login" className="text-primary hover:text-primary/80 font-medium">Sign in</Link>
                        </p>
                    </div>
